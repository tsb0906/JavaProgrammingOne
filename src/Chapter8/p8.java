...
/**
 * Program to create an array of data about salesmen, such as the day and the amount of the sale, with data entered by user
 *
    ...
    public static void main(String[] args) {
        ...
        for (int r = 0; r < calendar.length; r++) {
            ...
            for (int c = 0; c < calendar[r].length; c++) {
                ...
                int total = 0;
                for (int r = 0; r < calendar.length; r++){
                    for (int c = 0; colunm < matrix[r].length; c++
                            total += calendar[r][c]);
                }
            }
            System.out.println();
